package com.upgrad.paymentservice.config;

import com.upgrad.paymentservice.security.JWTAuthenticationFilter;
import com.upgrad.paymentservice.security.JWTTokenVerifier;
import com.upgrad.paymentservice.service.ApplicationUserDetailsService;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, AuthenticationManager authenticationManager) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/payments/**").hasAuthority("WRITE")
