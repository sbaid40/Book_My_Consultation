...
import com.upgrad.ratingservice.security.JWTAuthenticationFilter;
import com.upgrad.ratingservice.security.JWTTokenVerifier;
import com.upgrad.ratingservice.service.ApplicationUserDetailsService;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, AuthenticationManager authenticationManager) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/ratings/**").hasAuthority("WRITE")
